...
<tr>
<td rowspan="2" align="center" valign="middle" style="font-size:16px; " >




<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-nkl">
<table>
<tr><td><input type="hidden" name="on0" value="Full page - Back Cover">Full page - Back Cover</td></tr><tr><td><select name="os0">
	<option value="1 Insertion">1 Insertion $5.00 USD</option>
	<option value="4 Insertion">4 Insertion $18.00 USD</option>
	<option value="16 Insertions">16 Insertions $64.00 USD</option>
</select> </td></tr>
</table>
<input type="hidden" name="currency_code" value="USD">
<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_buynow_SM.gif" border="0" name="bautton" alt="PayPal - The safer, easier way to pay online!">
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1" style=" border:0;outline:none; ">
</form>
...
<td height="40" align="left" valign="middle" >Price:&nbsp;<input type="text" readonly name="price[2]" id="price[2]" style="width:60px; height:30; font-size:22px;border:none; color:#F00 ; text-align:right;" value="<?php if($price[2]=="") echo $baner[2]["price"]; else echo $price[2]; ?>" />&nbsp;$</td>
...
<td height="30" colspan="2" align="right"><a href="#"><img  src="img/add_cart_but.png"   style="border:0;"  /></a></td>
</tr>
<tr>
